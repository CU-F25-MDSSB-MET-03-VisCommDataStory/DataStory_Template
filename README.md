...
- Create your DataStory repository from this template. 

- Render `index.qmd` and `presentation.qmd` with quarto. This should produce a website `index.html` with a standalone revealjs presentation `presentation.html` which is also embedded as an `iframe`.
